...
func (s testFakeIPICMPCounterSource) FakeIPICMPEnabled() bool { return s.enabled }
func (s testFakeIPICMPCounterSource) FakeIPICMPReplyCount() (uint64, error) {
	return s.replies, nil
}
func (s testFakeIPICMPCounterSource) FakeIPICMPPassThroughCount() (uint64, error) {
	return s.passThrough, nil
}
func (s testFakeIPICMPCounterSource) FakeIPICMPRewriteFailureCount() (uint64, error) {
